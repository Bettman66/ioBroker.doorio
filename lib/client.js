                ...
                switch (jsonContent.type) {
                    ...
                    case ('CALL_DTMF_START'):
                        ...
                        if (dtmf == adapter.config.dtmf1) {
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out1) { adapter.setForeignState(adapter.config.out1, false, false); }
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out2) { adapter.setForeignState(adapter.config.out2, false, false); }
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out3) { adapter.setForeignState(adapter.config.out3, false, false); }
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out4) { adapter.setForeignState(adapter.config.out4, false, false); }
                    ...
                    case ('CALL_ESTABLISHED'):
                        ...
                        tout1 = setTimeout(() => {
                            tout1 = null;
                            if (adapter.config.call_established) { adapter.setForeignState(adapter.config.call_established, false, false); }
                    ...
                    case ('CALL_CLOSED'):
                        ...
                        tout2 = setTimeout(() => {
                            tout2 = null;
                            if (adapter.config.call_closed) { adapter.setForeignState(adapter.config.call_closed, false, false); }
