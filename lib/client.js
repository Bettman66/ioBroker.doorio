                ...
                switch (jsonContent.type) {
                    ...
                    case ('CALL_DTMF_START'):
                        ...
                        if (dtmf == adapter.config.dtmf1) {
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out1) { adapter.setForeignState(adapter.config.out1, false); }
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out2) { adapter.setForeignState(adapter.config.out2, false); }
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out3) { adapter.setForeignState(adapter.config.out3, false); }
                            ...
                            tout = setTimeout(() => {
                                tout = null;
                                if (adapter.config.out4) { adapter.setForeignState(adapter.config.out4, false); }
