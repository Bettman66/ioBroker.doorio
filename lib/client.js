...
function BaresipClient(adapter) {
    ...
    function send2Server(id, state) {
        ...
        switch (dp[2]) {
            case ('ring1button'):
                adapter.setState('ring1button', false, true);
                id = adapter.config.ring1;
                break;
            case ('ring2button'):
                adapter.setState('ring2button', false, true);
                id = adapter.config.ring2;
                break;
            case ('ring3button'):
                adapter.setState('ring3button', false, true);
                id = adapter.config.ring3;
                break;
            case ('ring4button'):
                adapter.setState('ring4button', false, true);
