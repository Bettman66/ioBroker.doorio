...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Walter Zengel';
    var email  = 'w.zengel@gmx.de';
    ...
    if (!newname) {
        console.log('Please write the new snips name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/snips.png')) {
        fs.renameSync(__dirname + '/admin/snips.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/snips.html')) {
        fs.renameSync(__dirname + '/widgets/snips.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/snips/js/snips.js')) {
        fs.renameSync(__dirname + '/widgets/snips/js/snips.js', __dirname + '/widgets/snips/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/snips')) {
        fs.renameSync(__dirname + '/widgets/snips',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /snips/g,
        ...
        {
            match: /Snips/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Snips'
        },
        {
            match: /Walter Zengel/g,
            replacement: author
        },
        {
            match: /w.zengel@gmx.de/g,
            replacement: email
        }
    ];
    var files = [
